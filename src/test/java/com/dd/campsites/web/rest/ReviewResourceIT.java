...
import com.dd.campsites.service.criteria.ReviewCriteria;
...
class ReviewResourceIT {
    ...
    private static final String DEFAULT_REVIEWB_BODY = "AAAAAAAAAA";
    private static final String UPDATED_REVIEWB_BODY = "BBBBBBBBBB";
    ...
    void getAllReviews() throws Exception {
        ...
        restReviewMockMvc
            ...
            .andExpect(jsonPath("$.[*].reviewbBody").value(hasItem(DEFAULT_REVIEWB_BODY.toString())))
    ...
    void getReview() throws Exception {
        ...
        restReviewMockMvc
            ...
            .andExpect(jsonPath("$.reviewbBody").value(DEFAULT_REVIEWB_BODY.toString()))
    ...
    @Test
    @Transactional
    void getAllReviewsByListingIsEqualToSomething() throws Exception {
        // Initialize the database
        reviewRepository.saveAndFlush(review);
        ...
        // Get all the reviewList where listing equals to listingId
        defaultReviewShouldBeFound("listingId.equals=" + listingId);

        // Get all the reviewList where listing equals to (listingId + 1)
        defaultReviewShouldNotBeFound("listingId.equals=" + (listingId + 1));
    }
