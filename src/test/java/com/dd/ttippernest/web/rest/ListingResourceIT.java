...
class ListingResourceIT {
    ...
    @Test
    @Transactional
    void getAllListingsByCommentIsEqualToSomething() throws Exception {
        // Initialize the database
        listingRepository.saveAndFlush(listing);

        // Get all the listingList where comment equals to DEFAULT_COMMENT
        defaultListingShouldBeFound("comment.equals=" + DEFAULT_COMMENT);

        // Get all the listingList where comment equals to UPDATED_COMMENT
        defaultListingShouldNotBeFound("comment.equals=" + UPDATED_COMMENT);
    }

    @Test
    @Transactional
    void getAllListingsByCommentIsNotEqualToSomething() throws Exception {
        // Initialize the database
        listingRepository.saveAndFlush(listing);

        // Get all the listingList where comment not equals to DEFAULT_COMMENT
        defaultListingShouldNotBeFound("comment.notEquals=" + DEFAULT_COMMENT);

        // Get all the listingList where comment not equals to UPDATED_COMMENT
        defaultListingShouldBeFound("comment.notEquals=" + UPDATED_COMMENT);
    }

    @Test
    @Transactional
    void getAllListingsByCommentIsInShouldWork() throws Exception {
        // Initialize the database
        listingRepository.saveAndFlush(listing);

        // Get all the listingList where comment in DEFAULT_COMMENT or UPDATED_COMMENT
        defaultListingShouldBeFound("comment.in=" + DEFAULT_COMMENT + "," + UPDATED_COMMENT);

        // Get all the listingList where comment equals to UPDATED_COMMENT
        defaultListingShouldNotBeFound("comment.in=" + UPDATED_COMMENT);
    }

    @Test
    @Transactional
    void getAllListingsByCommentIsNullOrNotNull() throws Exception {
        // Initialize the database
        listingRepository.saveAndFlush(listing);

        // Get all the listingList where comment is not null
        defaultListingShouldBeFound("comment.specified=true");

        // Get all the listingList where comment is null
        defaultListingShouldNotBeFound("comment.specified=false");
    }
    ...
    @Test
    @Transactional
    void getAllListingsByRatingIsEqualToSomething() throws Exception {
        // Initialize the database
        listingRepository.saveAndFlush(listing);
        ...
        // Get all the listingList where rating equals to ratingId
        defaultListingShouldBeFound("ratingId.equals=" + ratingId);

        // Get all the listingList where rating equals to (ratingId + 1)
        defaultListingShouldNotBeFound("ratingId.equals=" + (ratingId + 1));
    }
    ...
    @Test
    @Transactional
    void getAllListingsByFeatureIsEqualToSomething() throws Exception {
        // Initialize the database
        listingRepository.saveAndFlush(listing);
        ...
        // Get all the listingList where feature equals to featureId
        defaultListingShouldBeFound("featureId.equals=" + featureId);

        // Get all the listingList where feature equals to (featureId + 1)
        defaultListingShouldNotBeFound("featureId.equals=" + (featureId + 1));
    }

    @Test
    @Transactional
    void getAllListingsByRoomIsEqualToSomething() throws Exception {
        // Initialize the database
        listingRepository.saveAndFlush(listing);
        ...
        // Get all the listingList where room equals to roomId
        defaultListingShouldBeFound("roomId.equals=" + roomId);

        // Get all the listingList where room equals to (roomId + 1)
        defaultListingShouldNotBeFound("roomId.equals=" + (roomId + 1));
    }
