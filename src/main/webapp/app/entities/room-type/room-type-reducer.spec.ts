...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './room-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROOMTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ROOMTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ROOMTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ROOMTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ROOMTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ROOMTYPE actions', async () => {
      const expectedActions = [
        {
