            ...
            <tbody>
              {invoiceList.map((invoice, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{invoice.updatedBy ? <TextFormat type="date" value={invoice.updatedBy} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{invoice.updateDate ? <TextFormat type="date" value={invoice.updateDate} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{invoice.bookings ? <Link to={`bookings/${invoice.bookings.id}`}>{invoice.bookings.id}</Link> : ''}</td>
                  <td>{invoice.customer ? invoice.customer.email : ''}</td>
