...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './authenticated-user.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IAuthenticatedUser, defaultValue } from 'app/shared/model/authenticated-user.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AUTHENTICATEDUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_AUTHENTICATEDUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AUTHENTICATEDUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AUTHENTICATEDUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AUTHENTICATEDUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AUTHENTICATEDUSER actions', async () => {
      const expectedActions = [
        {
