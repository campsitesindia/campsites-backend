...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './comments.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMMENTS actions', async () => {
      const expectedActions = [
        {
