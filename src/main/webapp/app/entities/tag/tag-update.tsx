...
import { getEntities as getPhotos } from 'app/entities/photos/photos.reducer';
...
export const TagUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const photos = useAppSelector(state => state.photos.entities);
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="campsitesindiaApp.tag.home.createOrEditLabel" data-cy="TagCreateUpdateHeading">
            <Translate contentKey="campsitesindiaApp.tag.home.createOrEditLabel">Create or edit a Tag</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('campsitesindiaApp.tag.name')}
                id="tag-name"
                name="name"
                data-cy="name"
                type="text"
