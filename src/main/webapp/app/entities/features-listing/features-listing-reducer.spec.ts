...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FEATURESLISTING_LIST actions', async () => {
    ...
    it('dispatches FETCH_FEATURESLISTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FEATURESLISTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FEATURESLISTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FEATURESLISTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FEATURESLISTING actions', async () => {
      const expectedActions = [
        {
