...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './followers.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FOLLOWERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_FOLLOWERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FOLLOWERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FOLLOWERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FOLLOWERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FOLLOWERS actions', async () => {
      const expectedActions = [
        {
