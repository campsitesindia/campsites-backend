...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './videos.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIDEOS_LIST actions', async () => {
    ...
    it('dispatches FETCH_VIDEOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VIDEOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VIDEOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VIDEOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VIDEOS actions', async () => {
      const expectedActions = [
        {
