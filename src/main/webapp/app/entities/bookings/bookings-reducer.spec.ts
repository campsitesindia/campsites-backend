...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bookings.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOOKINGS_LIST actions', async () => {
    ...
    it('dispatches FETCH_BOOKINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BOOKINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BOOKINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BOOKINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BOOKINGS actions', async () => {
      const expectedActions = [
        {
