...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './listing-type.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IListingType, defaultValue } from 'app/shared/model/listing-type.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LISTINGTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_LISTINGTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LISTINGTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LISTINGTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LISTINGTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LISTINGTYPE actions', async () => {
      const expectedActions = [
        {
