...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FEATURESINROOM_LIST actions', async () => {
    ...
    it('dispatches FETCH_FEATURESINROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FEATURESINROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FEATURESINROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FEATURESINROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FEATURESINROOM actions', async () => {
      const expectedActions = [
        {
