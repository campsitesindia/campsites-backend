    ...
    <Row>
      <Col md="8">
        <h2 data-cy="imagesDetailsHeading">
          <Translate contentKey="campsitesindiaApp.images.detail.title">Images</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="imageUrl">
              <Translate contentKey="campsitesindiaApp.images.imageUrl">Image Url</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.imageUrl}</dd>
          <dt>
            <span id="createdBy">
              <Translate contentKey="campsitesindiaApp.images.createdBy">Created By</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.createdBy}</dd>
          <dt>
            <span id="createdDate">
              <Translate contentKey="campsitesindiaApp.images.createdDate">Created Date</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.createdDate ? <TextFormat value={imagesEntity.createdDate} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="updatedBy">
              <Translate contentKey="campsitesindiaApp.images.updatedBy">Updated By</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.updatedBy ? <TextFormat value={imagesEntity.updatedBy} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="updateDate">
              <Translate contentKey="campsitesindiaApp.images.updateDate">Update Date</Translate>
            </span>
          </dt>
          <dd>{imagesEntity.updateDate ? <TextFormat value={imagesEntity.updateDate} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <Translate contentKey="campsitesindiaApp.images.post">Post</Translate>
          </dt>
          <dd>{imagesEntity.post ? imagesEntity.post.id : ''}</dd>
          <dt>
            <Translate contentKey="campsitesindiaApp.images.user">User</Translate>
          </dt>
