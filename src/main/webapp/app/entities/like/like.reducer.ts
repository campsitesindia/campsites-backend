...
export const createEntity = createAsyncThunk(
  ...
  async (entity: ILike, thunkAPI) => {
    const result = await axios.post<ILike>(apiUrl, cleanEntity(entity));
...
export const updateEntity = createAsyncThunk(
  'like/update_entity',
  async (entity: ILike, thunkAPI) => {
    const result = await axios.put<ILike>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: ILike, thunkAPI) => {
    const result = await axios.patch<ILike>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    const result = await axios.delete<ILike>(requestUrl);
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError }
