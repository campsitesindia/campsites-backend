...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './listing.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IListing, defaultValue } from 'app/shared/model/listing.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LISTING_LIST actions', async () => {
    ...
    it('dispatches FETCH_LISTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LISTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LISTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LISTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LISTING actions', async () => {
      const expectedActions = [
        {
