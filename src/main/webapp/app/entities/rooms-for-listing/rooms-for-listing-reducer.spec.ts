...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './rooms-for-listing.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROOMSFORLISTING_LIST actions', async () => {
    ...
    it('dispatches FETCH_ROOMSFORLISTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ROOMSFORLISTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ROOMSFORLISTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ROOMSFORLISTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ROOMSFORLISTING actions', async () => {
      const expectedActions = [
        {
