...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROOMFEATURES_LIST actions', async () => {
    ...
    it('dispatches FETCH_ROOMFEATURES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ROOMFEATURES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ROOMFEATURES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ROOMFEATURES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ROOMFEATURES actions', async () => {
      const expectedActions = [
        {
