...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './features.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IFeatures, defaultValue } from 'app/shared/model/features.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FEATURES_LIST actions', async () => {
    ...
    it('dispatches FETCH_FEATURES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FEATURES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FEATURES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FEATURES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FEATURES actions', async () => {
      const expectedActions = [
        {
