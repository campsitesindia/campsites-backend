...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROOMSINBOOKING_LIST actions', async () => {
    ...
    it('dispatches FETCH_ROOMSINBOOKING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ROOMSINBOOKING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ROOMSINBOOKING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ROOMSINBOOKING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ROOMSINBOOKING actions', async () => {
      const expectedActions = [
        {
