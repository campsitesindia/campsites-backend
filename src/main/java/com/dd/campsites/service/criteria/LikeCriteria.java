...
/**
 * Criteria class for the {@link com.dd.campsites.domain.Like} entity. This class is used
 * in {@link com.dd.campsites.web.rest.LikeResource} to receive all the possible filtering options from
...
public class LikeCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, createdBy, createdDate, updatedBy, updateDate, postId, userId, imagesId);
    }
