...
/**
 * Criteria class for the {@link com.dd.campsites.domain.Tag} entity. This class is used
 * in {@link com.dd.campsites.web.rest.TagResource} to receive all the possible filtering options from
...
public class TagCriteria implements Serializable, Criteria {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) && Objects.equals(name, that.name) && Objects.equals(photosId, that.photosId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, name, photosId);
    }
