...
import com.dd.campsites.service.ListingTypeQueryService;
import com.dd.campsites.service.ListingTypeService;
...
/**
 * REST controller for managing {@link com.dd.campsites.domain.ListingType}.
 */
@RestController
@RequestMapping("/api")
