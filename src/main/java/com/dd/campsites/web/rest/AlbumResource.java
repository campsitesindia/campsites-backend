...
import com.dd.campsites.service.AlbumQueryService;
...
/**
 * REST controller for managing {@link com.dd.campsites.domain.Album}.
 */
@RestController
@RequestMapping("/api")
public class AlbumResource {
     ...
     */
    @GetMapping("/albums")
    public ResponseEntity<List<Album>> getAllAlbums(AlbumCriteria criteria, Pageable pageable) {
