...
public class RoomType implements Serializable {
    ...
    @Column(name = "room_rate_per_nigt")
    private Double roomRatePerNigt;
    ...
    public Double getRoomRatePerNigt() {
        return this.roomRatePerNigt;
    }

    public RoomType roomRatePerNigt(Double roomRatePerNigt) {
        this.roomRatePerNigt = roomRatePerNigt;
        return this;
    }

    public void setRoomRatePerNigt(Double roomRatePerNigt) {
        this.roomRatePerNigt = roomRatePerNigt;
    }
    ...
    public String toString() {
        return "RoomType{" +
            ...
            ", roomRatePerNigt=" + getRoomRatePerNigt() +
