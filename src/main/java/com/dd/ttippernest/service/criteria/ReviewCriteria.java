...
/**
 * Criteria class for the {@link com.dd.ttippernest.domain.Review} entity. This class is used
 * in {@link com.dd.ttippernest.web.rest.ReviewResource} to receive all the possible filtering options from
...
public class ReviewCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, rating, createdBy, createdDate, updatedBy, updateDate, bookingId);
    }
