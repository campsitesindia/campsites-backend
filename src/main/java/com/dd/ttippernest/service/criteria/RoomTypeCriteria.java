...
/**
 * Criteria class for the {@link com.dd.ttippernest.domain.RoomType} entity. This class is used
 * in {@link com.dd.ttippernest.web.rest.RoomTypeResource} to receive all the possible filtering options from
...
public class RoomTypeCriteria implements Serializable, Criteria {
    ...
    private DoubleFilter roomRatePerNigt;
    ...
    public RoomTypeCriteria(RoomTypeCriteria other) {
        ...
        this.roomRatePerNigt = other.roomRatePerNigt == null ? null : other.roomRatePerNigt.copy();
    ...
    public DoubleFilter getRoomRatePerNigt() {
        return roomRatePerNigt;
    }

    public DoubleFilter roomRatePerNigt() {
        if (roomRatePerNigt == null) {
            roomRatePerNigt = new DoubleFilter();
        }
        return roomRatePerNigt;
    }

    public void setRoomRatePerNigt(DoubleFilter roomRatePerNigt) {
        this.roomRatePerNigt = roomRatePerNigt;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(roomRatePerNigt, that.roomRatePerNigt) &&
    ...
    public String toString() {
        return "RoomTypeCriteria{" +
            ...
            (roomRatePerNigt != null ? "roomRatePerNigt=" + roomRatePerNigt + ", " : "") +
