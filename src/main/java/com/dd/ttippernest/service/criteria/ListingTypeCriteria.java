...
/**
 * Criteria class for the {@link com.dd.ttippernest.domain.ListingType} entity. This class is used
 * in {@link com.dd.ttippernest.web.rest.ListingTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /listing-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ListingTypeCriteria implements Serializable, Criteria {
    ...
    public ListingTypeCriteria() {}

    public ListingTypeCriteria(ListingTypeCriteria other) {
    ...
    @Override
    public ListingTypeCriteria copy() {
        return new ListingTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ListingTypeCriteria that = (ListingTypeCriteria) o;
        return (
