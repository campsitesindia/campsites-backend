...
/**
 * Criteria class for the {@link com.dd.ttippernest.domain.Location} entity. This class is used
 * in {@link com.dd.ttippernest.web.rest.LocationResource} to receive all the possible filtering options from
...
public class LocationCriteria implements Serializable, Criteria {
    ...
    private LongFilter parentLocationId;
    ...
    public LocationCriteria(LocationCriteria other) {
        ...
        this.parentLocationId = other.parentLocationId == null ? null : other.parentLocationId.copy();
    }
    ...
    public LongFilter getParentLocationId() {
        return parentLocationId;
    }

    public LongFilter parentLocationId() {
        if (parentLocationId == null) {
            parentLocationId = new LongFilter();
        }
        return parentLocationId;
    }

    public void setParentLocationId(LongFilter parentLocationId) {
